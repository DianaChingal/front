...
export function ProductsFormPage() {
  ...
  return (
    <div className='w-full md:w-1/2 mx-auto p-4 bg-zinc-800 rounded-lg shadow-lg'>
      ...
      <input type="number" placeholder='Tipo de producto' className="bg-zinc-700 rounded-lg block w-full mb-3 p-2 text-white"
      ...
      <input type='number' placeholder='Bodega' className="bg-zinc-700 rounded-lg block w-full mb-3 p-2 text-white"
